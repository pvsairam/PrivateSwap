...
/**
 * @title EncryptedPETH
 * @notice Encrypted Private ETH token using Zama's FHEVM (Fully Homomorphic Encryption)
 ...
 */
contract EncryptedPETH is ConfidentialERC20 {
    ...
    constructor() ConfidentialERC20("Encrypted Private ETH", "ePETH") {
        owner = msg.sender;
    }
